...
import { ReactComponent as ExclaimIcon } from "../Assets/images/exclaim.svg";
import { ReactComponent as HashIcon } from "../Assets/images/hashtag.svg";
import { ReactComponent as HeartIcon } from "../Assets/images/heart.svg";
import { ReactComponent as HeartIcon2 } from "../Assets/images/heart.svg";
...
export const Cursor = <CursorIcon className="icon icon--cursor" />;
export const Dots = <DotsIcon className="icon icon--dots" />;
...
export const Plus = <PlusIcon className="icon icon--plus" />;
export const Sad = <SadIcon className="icon icon--sad" />;
